...
<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-indicators">
        @for ($i = 0; $i < sizeof($carousel); $i++) @if ($i==0) <button class="active" aria-current="true" type="button" data-bs-target="#heroCarousel" data-bs-slide-to="{{ $i }}" aria-label="Slide {{ $i }}"></button>
            @else
    ...
    <div class="carousel-inner">
        @for ($i = 0; $i < sizeof($carousel); $i++) <div class="carousel-item {{ $i == 0 ? 'active' : '' }}" style="background-image: url({{ asset($carousel[$i]->image) }})">
            <div class="container">
