<x-dashboard.app>
    <div class="container-md container-sm-small mt-4">
        <x-dashboard.navbar />

        <x-errors></x-errors>

        <form method="POST" name="form" action="{{ route('dashboard.gallery.submit') }}"
                    ...
                    <div class="col-4">
                        <div class="form-group mh-100">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="picture-{{ $picture->id }}"
                                    name="picture-{{ $picture->id }}" value="{{ $picture->name }}" />
