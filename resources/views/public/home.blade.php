<x-app>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center my-5">
            <div class="col-10">
                <h1 class="text-center">Camping now available at {!! config('app.name') !!}!</h1>
                <p>
                    ...
                    <br><br>
                    We hope you enjoy your stay at Stoney Campgrounds!
                </p>
            </div>
            <div class="w-100">
                <hr>
            ...
            <div class="col-10 text-center">
                <h3><i class="fas fa-map-marker-alt"></i> Where to find us</h3>
                <p>
